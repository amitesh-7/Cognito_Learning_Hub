...
const FeatureComparison = () => {
  ...
  const features = [
    ...
    {
      category: "ai",
      name: "AI Opponent Duels",
      description: "Battle against AI with unique personalities",
      details: "Einstein (92% accuracy), Speedy (ultra-fast), Careful (balanced) - each with unique taunts",
      cognito: { value: "3 AI Personas", icon: Check, highlight: true },
      kahoot: { value: "None", icon: X },
      quizlet: { value: "None", icon: X },
      duolingo: { value: "None", icon: X },
    },
    ...
    },
    {
      ...
      details: "6-digit codes, 100+ capacity, real-time leaderboards, QR code join",
    ...
    },
    {
      ...
      details: "1400+ quests, 14 realms (Math Kingdom, Physics Universe, etc.), NPCs, boss battles",
      cognito: { value: "14 Realms", icon: Check, highlight: true },
      kahoot: { value: "None", icon: X },
      quizlet: { value: "None", icon: X },
    ...
    {
      category: "learning",
      name: "Code Challenge Questions",
      description: "Live code execution in quizzes",
      details: "Python, JavaScript, Java, C++ - sandboxed execution environment",
      cognito: { value: "4 Languages", icon: Check, highlight: true },
      kahoot: { value: "None", icon: X },
      quizlet: { value: "None", icon: X },
      duolingo: { value: "None", icon: X },
    },
    // Gamification Features
    {
      ...
      details: "8 base characters, 150+ items, achievement-based unlocks, dynamic moods",
    ...
    },
    {
      ...
      details: "100+ achievements, 4 rarity tiers (Common, Rare, Epic, Legendary), secret achievements",
      cognito: { value: "100+ (4 Tiers)", icon: Check, highlight: true },
      kahoot: { value: "Basic", icon: Check },
    ...
    },
    {
      ...
      details: "3 daily quests (Easy/Medium/Hard), avatar rewards, streak bonuses, XP multipliers",
      cognito: { value: "3 Daily + Rewards", icon: Check, highlight: true },
      kahoot: { value: "None", icon: X },
    ...
    },
    {
      ...
      details: "50+ levels, prestige system, visual level badges, XP multipliers",
      cognito: { value: "50+ Levels", icon: Check, highlight: true },
    ...
    {
      category: "gamification",
      name: "Streak & Combo System",
      description: "Reward consistency and consecutive correct answers",
      details: "Daily streaks, answer combos, streak protection, bonus rewards",
      cognito: { value: "Full System", icon: Check, highlight: true },
      kahoot: { value: "None", icon: X },
      quizlet: { value: "Basic", icon: Check },
      duolingo: { value: "Yes", icon: Check, highlight: true },
    },
    // Social Features
    {
      ...
      details: "Friend discovery, requests, online status, comprehensive social dashboard",
    ...
    },
    {
      ...
      details: "Online status, typing indicators, message history, rich media",
    ...
    },
    {
      ...
      details: "Send challenges, receive notifications, track wins/losses, leaderboards",
    ...
    },
    {
      ...
      description: "Real-time alerts for all activities",
      details: "Friend requests, challenges, achievements, system notifications with actions",
      cognito: { value: "Full Center", icon: Check, highlight: true },
      kahoot: { value: "Basic", icon: Check },
      quizlet: { value: "Basic", icon: Check },
      duolingo: { value: "Push Only", icon: Check },
    },
    // Accessibility Features (NEW CATEGORY)
    {
      category: "accessibility",
      name: "KBC-Style Voice Quiz ♿",
      description: "Complete voice-based quiz experience for visually impaired",
      details: "Text-to-speech, voice commands, 'Lock kiya jaaye?' confirmation - First in Indian EdTech",
      cognito: { value: "Full Voice UI", icon: Check, highlight: true },
      kahoot: { value: "None", icon: X },
      quizlet: { value: "None", icon: X },
      duolingo: { value: "TTS Only", icon: Check },
    },
    {
      category: "accessibility",
      name: "Keyboard Navigation",
      description: "Full keyboard-only operation",
      details: "20+ shortcuts (1-4 for answers, N/P for nav, R to read), skip links, focus indicators",
      cognito: { value: "20+ Shortcuts", icon: Check, highlight: true },
      kahoot: { value: "Basic", icon: Check },
      quizlet: { value: "Basic", icon: Check },
      duolingo: { value: "Limited", icon: Check },
    },
    {
      ...
      description: "Full ARIA compliance and announcements",
      details: "ARIA labels, live regions, semantic HTML, screen reader announcer",
      cognito: { value: "Full ARIA", icon: Check, highlight: true },
      kahoot: { value: "Partial", icon: Check },
      quizlet: { value: "Partial", icon: Check },
      duolingo: { value: "Good", icon: Check },
    },
    {
      category: "accessibility",
      name: "Visual Accessibility",
      description: "High contrast, font size, dyslexia support",
      details: "High contrast mode, adjustable fonts, OpenDyslexic font, reading guide",
      cognito: { value: "Full Suite", icon: Check, highlight: true },
      kahoot: { value: "Limited", icon: Check },
      quizlet: { value: "Basic", icon: Check },
      duolingo: { value: "Limited", icon: Check },
    },
