...
import { Flag, CheckCircle, XCircle, Trophy, Clock, ChevronLeft, ChevronRight, AlertTriangle, Star, FileText, Copy, Download, BarChart, Home, RotateCcw, Share2 } from 'lucide-react';
        ...
        >
          <Card className="p-8 text-center shadow-2xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg">
            <div className="relative">
              <LoadingSpinner size="lg" className="mx-auto mb-6 text-indigo-600 dark:text-indigo-400" />
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-2">Preparing Your Quiz</h3>
            <p className="text-gray-600 dark:text-gray-300">Please wait while we load your questions...</p>
          </Card>
        </motion.div>
      </div>
    );
  ...
  if (isFinished) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-green-900 relative overflow-hidden">
        <Confetti recycle={false} numberOfPieces={isExcellent ? 300 : isGood ? 150 : 50} />
              ...
              <CardContent className="space-y-8">
                ...
                >
                  ...
                  <div className="flex justify-center">
                    <Badge 
                      variant={isExcellent ? "success" : isGood ? "warning" : "destructive"} 
                      size="lg"
                  ...
                  <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-2xl font-bold text-red-600 dark:text-red-400">{quiz.questions.length - score}</div>
            ...
            <CardHeader className="pb-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <CardDescription className="mt-2 text-lg">
                    Question {currentQuestionIndex + 1} of {quiz.questions.length} • Score: 
                    <span className="font-semibold text-indigo-600 dark:text-indigo-400 ml-1">{score}</span>
                  </CardDescription>
                </div>
                <div className="flex items-center gap-3">
                  <div className={cn(
                    "flex items-center gap-2 px-4 py-2 rounded-xl font-bold shadow-lg transition-all duration-300",
                    timeLeft <= 10 ? "bg-gradient-to-r from-red-500 to-pink-500 text-white animate-pulse" : 
                    timeLeft <= 20 ? "bg-gradient-to-r from-yellow-400 to-orange-500 text-white" :
              ...
              <div className="space-y-4 mt-6">
                ...
                <Progress 
                  ...
                  variant={timeLeft <= 10 ? "destructive" : timeLeft <= 20 ? "warning" : "success"} 
          ...
          >
            <Card className="overflow-hidden shadow-xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg">
              <CardHeader className="bg-gradient-to-r from-indigo-100 to-purple-100 dark:from-indigo-900/30 dark:to-purple-900/30 py-8">
                <CardTitle className="text-2xl text-center leading-relaxed font-bold text-gray-800 dark:text-white">
              ...
              <CardContent className="p-8">
                ...
                >
                  {currentQuestion.options.map((option, index) => {
                    ...
                    let buttonClass = "h-auto p-6 text-left justify-start text-lg font-medium transition-all duration-300 transform hover:scale-105";

                    if (showResult) {
                      if (isCorrect) {
                        buttonClass += " border-green-500 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900 text-green-800 dark:text-green-200 shadow-lg";
                      } else if (isSelected) {
                        buttonClass += " border-red-500 bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900 dark:to-pink-900 text-red-800 dark:text-red-200 shadow-lg";
                      } else {
                        buttonClass += " opacity-60 bg-gray-50 dark:bg-gray-700";
                      }
                    } else {
                      buttonClass += " border-gray-300 dark:border-gray-600 hover:border-indigo-400 dark:hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900 hover:shadow-lg";
                    }
