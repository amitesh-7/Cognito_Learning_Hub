...
const carouselItems = [
  { 
    ...
    description: "Generate engaging quizzes from any topic or document in seconds.",
    badge: "Smart AI"
  },
  { 
    icon: Gamepad2, 
    title: "Interactive & Fun Learning", 
    description: "Experience a modern, gamified quiz experience that makes learning enjoyable.",
    badge: "Gamified"
  },
  { 
    icon: MessageCircle, 
    title: "24/7 AI Tutor Support", 
    description: "Get instant, personalized explanations from your AI tutor anytime.",
          ...
          >
            ...
            <div className="relative z-10 flex flex-col justify-between h-full">
              ...
              >
                ...
                <p className="text-blue-100 text-lg">Start your intelligent learning journey today</p>
              </motion.div>
                ...
                {carouselItems.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-blue-100 text-lg leading-relaxed max-w-sm">{item.description}</p>
                    </motion.div>
                  );
                })}
              </div>
                ...
                {carouselItems.map((_, index) => (
                  <motion.button 
                    ...
                    className={`h-3 w-3 rounded-full transition-all duration-300 ${
                      index === activeIndex ? 'bg-white w-10' : 'bg-white/50 hover:bg-white/70'
                    }`}
          ...
          >
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Join QuizWise AI</h1>
              </div>
              <p className="text-gray-600 dark:text-gray-400">Start your intelligent learning journey</p>
            </motion.div>
            ...
            >
              {/* Header */}
              <motion.div className="hidden lg:block text-center" variants={itemVariants}>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                {/* Mobile Login Link */}
                <motion.div className="lg:hidden text-center" variants={itemVariants}>
