...
import { Edit3, Trash2, ExternalLink, AlertTriangle, Users, BookOpen, Award, TrendingUp, Plus, Search, FileText, Radio, History } from 'lucide-react';
    ...
    >
      ...
      >
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent mb-3">{title}</h3>
                    ...
                    <div className="space-y-6">
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Total Takes</p>
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Unique Students</p>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3">
                      <Link to="/manual-quiz-creator">
                        <Button className="w-full justify-start bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900 hover:from-blue-100 hover:to-indigo-100 dark:hover:from-blue-900 dark:hover:to-indigo-900 border-blue-200 dark:border-blue-700 text-blue-700 dark:text-blue-300 transition-all duration-300" variant="outline">
                      ...
                      <Link to="/live/history">
                        <Button className="w-full justify-start bg-gradient-to-r from-pink-50 to-rose-50 dark:from-pink-900 dark:to-rose-900 hover:from-pink-100 hover:to-rose-100 dark:hover:from-pink-900 dark:hover:to-rose-900 border-pink-200 dark:border-pink-700 text-pink-700 dark:text-pink-300 transition-all duration-300" variant="outline">
