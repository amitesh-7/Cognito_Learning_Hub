...
const quickActions = [
  ...
  },
  {
    ...
    color: "from-green-500 to-yellow-800",
  },
  {
    icon: "🧮",
...
const MessageBubble = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={`max-w-sm sm:max-w-xs md:max-w-md p-3 sm:p-4 rounded-2xl shadow-lg border ${
          isUser
        ...
        <p
          className={`${
            ...
            accessibilityMode === "dyslexia"
              ? "font-mono tracking-wider leading-loose text-left"
              : ""
...
export default function DoubtSolver() {
  ...
  const [messages, setMessages] = useState([
    {
      ...
      text: `Hello ${
        user?.name || "there"
      }! 👋 I'm your AI Tutor, ready to help you with any academic questions. What would you like to learn today?`,
      timestamp: new Date(),
      id: 1,
    },
  ]);
  ...
  useEffect(() => {
    const handleKeyPress = (e) => {
      ...
      if (e.altKey && e.key === "a") {
        e.preventDefault();
        document
          .querySelector('[aria-label="Accessibility Settings"]')
          ?.focus();
      }
      ...
      if (e.altKey && e.key === "c") {
        e.preventDefault();
        document
          .querySelector('[aria-label="Type your question here"]')
          ?.focus();
      }
  ...
  const handleSendMessage = async (e, messageText = input) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/api/doubt-solver`,
        {
          method: "POST",
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-2">
                  <div className="flex justify-between">
                    <kbd className="px-2 py-1 bg-gray-200 dark:bg-gray-600 rounded text-sm">
                      Alt + A
                    </kbd>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Switch between Normal, Dyslexia-friendly (monospace font
                        with wider spacing), and High Contrast modes for better
                        readability.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Adjust colors for Deuteranopia, Protanopia, and
                        Tritanopia color vision deficiencies.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Reduce or disable animations and transitions for users
                        sensitive to motion.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Screen reader announcements, text-to-speech, and voice
                        input capabilities.
                      </p>
                    </div>
                  </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-gray-600 dark:text-gray-400">
                  <li>
                    Use larger font sizes if you have difficulty reading small
                    text
                  </li>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                  ...
                  <Button
                    ...
                    className={`flex items-center gap-2 ${
                      screenReaderMode
                        ? "bg-purple-50 dark:bg-purple-900 border-purple-300 dark:border-purple-600"
                        : ""
                    }`}
                  >
                ...
                <div className="mt-4 text-xs text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-medium">
                      Complete Accessibility Status
                    </span>
                  </div>
                  <p>
                    Mode: {accessibilityMode} • Colors: {colorBlindMode} •
                    Motion: {reducedMotion ? "Reduced" : "Normal"} • Voice:{" "}
                    {voiceEnabled ? "Enabled" : "Disabled"} • Auto-Speak:{" "}
                    {autoSpeak ? "On" : "Off"} • Screen Reader:{" "}
                    {screenReaderMode ? "On" : "Off"} • Focus:{" "}
                    {focusMode ? "On" : "Off"}
                  </p>
                </div>
              </div>
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-800 p-4 ${getAccessibilityClasses()}`}
    >
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <Badge
              variant="outline"
              className="border-indigo-200 text-indigo-700 dark:border-indigo-600 dark:text-indigo-300"
            >
                ...
                >
                  <div className="flex-1 relative">
                    ...
                    <div id="input-help" className="sr-only">
                      Type your academic question and press Enter to send, or
