  ...
  const features = [
    {
      ...
      description:
        "Unique 4-method quiz creation: Topic-based AI generation, PDF upload analysis, YouTube video transcription, and manual creation with AI assistance. No competitor offers this versatility.",
      icon: Sparkles,
      color: "from-blue-500 to-indigo-500",
      highlights: [
        "Topic-Based: Generate from any subject instantly",
        "PDF Upload: Extract questions from documents (up to 10MB)",
        "YouTube Integration: Auto-generate from video transcripts",
        "Manual + AI Assist: Create with intelligent suggestions",
        "Adaptive difficulty based on performance",
        "Real-time generation (15-30 seconds)",
      ],
      demo: '4 ways to create: Enter "Quantum Physics", upload notes PDF, paste YouTube URL, or build manually with AI help',
    },
    {
      id: "1v1-duel",
      ...
      description:
        "Game-like 1v1 battles with ELO ranking, power-ups, and speed multipliers. Live scoring via Socket.IO and Redis Pub/Sub ensures instant updates. No educational platform has this level of gaming integration.",
      icon: Gamepad2,
      color: "from-red-500 to-orange-500",
      highlights: [
        "Real-time battles with <100ms latency",
        "ELO ranking system for skill-based matchmaking",
        "Speed multiplier: Points = Correctness × Speed",
        "Battle history tracking and analytics",
        "Power-ups and special abilities",
        "XP, coins, and achievement rewards",
      ],
      demo: "Challenge friends or random opponents in lightning-fast quiz battles with game-like mechanics!",
    },
    {
      id: "live-multiplayer",
    ...
    {
      id: "rpg-quest-system",
      title: "Narrative-Driven RPG Quest System",
      subtitle: "Learning as an Adventure",
      description:
        "700+ quests across 5 themed realms with NPC guides, branching storylines, and boss battles. Star ratings (1-3 stars), retry mechanics, and exclusive avatar rewards. No platform combines education with full RPG mechanics like this.",
      icon: Trophy,
      color: "from-orange-500 to-red-500",
      highlights: [
        "5 Realms: Math, Physics, Chemistry, Biology, CS",
        "700+ quests with story-driven progression",
        "NPC guides with unique personalities & hints",
        "Boss battles for chapter completion",
        "Branching paths based on performance",
        "Exclusive rewards: XP, gold, avatar items, badges",
      ],
      demo: "Embark on epic learning journeys through Mathematics Kingdom or Physics Universe with NPC companions!",
    },
    {
      id: "customizable-avatars",
      title: "Earn-to-Unlock Avatar System",
      subtitle: "150+ Customization Items",
      description:
        "Achievement-based avatar customization with 8 base characters, 15+ hairstyles, 20+ facial features, 25+ head accessories, and 50+ badges. Unlock through achievements, quests, and daily challenges—not purchases.",
      icon: Palette,
      color: "from-pink-500 to-purple-500",
      highlights: [
        "150+ unique customization pieces",
        "8 base characters with distinct personas",
        "Dynamic mood system (happy, focused, tired)",
        "Unlock via achievements, not purchases",
        "Rarity tiers: Common, Rare, Epic, Legendary",
        "Collection progress tracking",
      ],
      demo: "Build your unique avatar by earning items through learning achievements and quest completions!",
    },
    {
      id: "ai-chatbot",
      ...
      description:
        "Google Gemini-powered AI that remembers your quiz history, knows your weak topics, and uses Socratic teaching methods. Multi-format support with KaTeX rendering for math formulas.",
      icon: Bot,
      color: "from-purple-500 to-pink-500",
      highlights: [
        "Contextual: Remembers your learning journey",
        "Socratic Method: Guides you to answers",
        "24/7 instant responses with conversation history",
        "Math formula rendering (KaTeX)",
        "Smart suggestions based on performance",
        "Adaptive explanation complexity",
      ],
      demo: 'Ask "Why did I get this wrong?" and get personalized explanations based on your quiz history',
    },
    {
      id: "webrtc-video-meetings",
      title: "WebRTC Video Meetings (SFU)",
      subtitle: "Scalable Educational Video Conferencing",
      description:
        "MediaSoup SFU architecture enables 50+ participant meetings with HD quality, screen sharing, and quiz integration. Unique whiteboard and breakout rooms for collaborative learning.",
      icon: Users,
      color: "from-blue-500 to-cyan-500",
      highlights: [
        "SFU Architecture: Scalable to 50+ participants",
        "HD video up to 1080p with adaptive quality",
        "Screen sharing & virtual backgrounds",
        "Launch quizzes during meetings",
        "Attendance tracking & engagement metrics",
        "Echo cancellation & noise suppression",
      ],
      demo: "Host virtual classrooms with HD video, launch quizzes mid-session, and track student engagement!",
    },
    {
      id: "daily-quests",
      title: "Daily Quest Challenge System",
      subtitle: "Fresh Challenges Every Day",
      description:
        "3 new quests daily with difficulty tiers (Easy, Medium, Hard). Earn exclusive avatar items and XP bonuses. Streak bonuses for consistency. Auto-refresh at midnight.",
      icon: Target,
      color: "from-green-500 to-emerald-500",
      highlights: [
        "3 fresh quests daily (Easy, Medium, Hard)",
        "Avatar item rewards (headwear, accessories, badges)",
        "Streak bonuses for consistency",
        "Quest types: Quiz completion, high scores, duels",
        "XP multipliers up to 3x",
        "Auto-expire and refresh system",
      ],
      demo: "Complete daily quests to unlock rare avatar items and maintain your learning streak!",
    },
    {
    ...
    {
      id: "achievements",
      title: "Multi-Layer Achievement System",
      subtitle: "100+ Achievements with Rarity Tiers",
      description:
        "Progressive achievement system across 8 categories with rarity tiers (Common, Rare, Epic, Legendary). Secret achievements, streak rewards, and avatar unlocks. Auto-unlocking with Redis caching.",
      icon: Award,
      ...
      highlights: [
        ...
        "Categories: Quizzes, Scores, Streaks, Speed, Duels",
        "Auto-unlock avatar rewards",
        "Progressive tracking (e.g., 10/50/100 quizzes)",
      ],
      demo: "Unlock rare achievements like '365-Day Streak' or 'Quiz Master 200' with exclusive avatar rewards!",
    },
  ];
