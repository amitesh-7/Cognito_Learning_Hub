  ...
  const features = [
    {
      ...
      description: 'Get instant answers to your questions with our advanced AI chatbot. Powered by cutting-edge AI technology to help you understand complex concepts.',
      icon: Bot,
    ...
    },
    {
      ...
      description: 'Seamless communication platform with real-time messaging, online status, and smart features for collaborative learning.',
      icon: MessageCircle,
    ...
    },
    {
      ...
      description: 'Track your progress and compete with peers on our dynamic leaderboard system. Gamify your learning experience.',
      icon: Trophy,
    ...
    },
    {
      ...
      description: 'Challenge your friends to quizzes and compete in a fun, educational environment. Make learning social and engaging.',
      icon: Users,
    ...
    },
    {
      ...
      description: 'Upload any PDF document and let our AI create intelligent quizzes from the content. Perfect for study materials and textbooks.',
      icon: FileText,
    ...
    },
    {
      ...
      description: 'Support for various question formats including MCQs, true/false, fill-in-the-blanks, and essay questions.',
      icon: HelpCircle,
    ...
    },
    {
      ...
      description: 'Generate quizzes on specific topics or subjects. Perfect for targeted practice and concept reinforcement.',
      icon: Target,
    ...
    },
    {
      ...
      description: 'Comprehensive analytics and reporting system to track learning progress, identify weak areas, and optimize study patterns.',
      icon: BarChart3,
  ...
  const userRoles = [
    {
      role: 'Students',
      icon: BookOpen,
      features: ['AI Doubt Solver', 'Friend Challenges', 'Leaderboard', 'Chat System'],
      description: 'Comprehensive learning platform with AI assistance and social features'
    },
    {
      role: 'Teachers',
      icon: UserCheck,
      features: ['Quiz Creation', 'Student Analytics', 'Community Management', 'Progress Tracking'],
      description: 'Advanced tools for educators to create, manage, and track student progress'
    },
    {
      role: 'Administrators',
      icon: Shield,
      features: ['User Management', 'Content Moderation', 'System Analytics', 'Broadcast Messages'],
      description: 'Complete platform control with administrative tools and oversight'
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto mb-12 leading-relaxed">
            ...
            <span className="text-blue-600 dark:text-blue-400 font-semibold"> intelligent learning</span>, 
            <span className="text-purple-600 dark:text-purple-400 font-semibold"> social collaboration</span>, and 
            <span className="text-indigo-600 dark:text-indigo-400 font-semibold"> academic excellence</span>.
          </p>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                ...
                <div className="text-3xl lg:text-4xl font-bold text-gray-800 dark:text-white mb-2">{stat.number}</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-800 dark:text-white mb-6">
              ...
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"> Every Learner</span>
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Explore our comprehensive feature set designed to transform your learning experience
            </p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-12">
                <div className="flex items-center gap-4 mb-6">
                  <div className={`p-4 rounded-2xl bg-gradient-to-r ${features[activeFeature].color}`}>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-semibold text-gray-800 dark:text-white">Try it out:</span>
                  </div>
                  <p className="text-gray-600 dark:text-gray-400 italic">{features[activeFeature].demo}</p>
                </div>
              </div>

              {/* Visual Side */}
              <div className={`bg-gradient-to-br ${features[activeFeature].color} p-12 flex items-center justify-center`}>
                <div className="text-center text-white">
                  {React.createElement(features[activeFeature].icon, { className: "w-32 h-32 mx-auto mb-6 opacity-80" })}
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Whether you're a student, teacher, or administrator, QuizWise-AI has features tailored for you
            </p>
          </div>

          <div className="grid lg:grid-cols-3 gap-8">
            {userRoles.map((role, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
                <div className="text-center mb-6">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300">
                    <role.icon className="w-8 h-8 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-3">{role.role}</h3>
                  <p className="text-gray-600 dark:text-gray-400">{role.description}</p>
                </div>

                <div className="space-y-3">
                  {role.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="flex items-center gap-3 bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                      <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0" />
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-800 dark:text-white mb-6">
            Built with 
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Cutting-Edge Technology</span>
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-12">
            QuizWise-AI leverages the latest technologies to deliver a seamless and powerful learning experience
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
            {[
              ...
              <div key={index} className="group">
                <div className={`h-24 w-24 mx-auto rounded-2xl bg-gradient-to-r ${tech.color} flex items-center justify-center text-white font-bold text-lg group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                  {tech.name.slice(0, 2)}
                </div>
                <p className="mt-3 font-medium text-gray-700 dark:text-gray-300">{tech.name}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl opacity-90 mb-8">
            Join thousands of students and educators who are already experiencing the power of AI-driven learning
          </p>
          <div className="flex flex-wrap justify-center gap-4">
