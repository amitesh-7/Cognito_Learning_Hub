      ...
      <div className="relative z-10 space-y-24 md:space-y-32">
        ...
        >
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-12 text-center">
              <div>
                <div className="text-5xl font-bold text-indigo-200 dark:text-indigo-500 mb-2">
                  1
                </div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Choose your method: generate with AI from a topic or file, or
                  build your quiz manually for full control.
                </p>
              </div>
              <div>
                <div className="text-5xl font-bold text-indigo-200 dark:text-indigo-500 mb-2">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Take quizzes with our interactive player. Teachers can easily
                  share quizzes with their students.
                </p>
              </div>
              <div>
                <div className="text-5xl font-bold text-indigo-200 dark:text-indigo-500 mb-2">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Track your scores on your personal dashboard and use the AI
                  Doubt Solver to understand difficult concepts.
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
              <p className="text-gray-700 dark:text-gray-300 italic">
                "The AI Doubt Solver is my favorite feature. It's like having a
                24/7 tutor. I finally understand complex topics I used to
                struggle with."
              </p>
              <p className="mt-4 font-bold text-right text-gray-900 dark:text-white">
                - Shashank, 11th Grade Student
              </p>
            </div>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="mt-8">
            <Link
              to="/signup"
              className="px-10 py-4 bg-white text-indigo-900 font-bold rounded-lg shadow-lg hover:bg-gray-100 transition-transform transform hover:scale-105"
            >
