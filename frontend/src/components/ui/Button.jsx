...
const Button = React.forwardRef(({ 
  ...
  const baseStyles = "inline-flex items-center justify-center rounded-lg font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none relative overflow-hidden group";
  ...
  const variants = {
    ...
    outline: "border-2 border-indigo-300 dark:border-indigo-500 bg-white/90 dark:bg-gray-800/90 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 hover:border-indigo-500 dark:hover:border-indigo-400 focus:ring-indigo-500 backdrop-blur-sm shadow-md hover:shadow-lg transform hover:-translate-y-0.5",
    secondary: "bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 text-gray-900 dark:text-gray-100 hover:from-gray-200 hover:to-gray-300 dark:hover:from-gray-600 dark:hover:to-gray-500 focus:ring-gray-500 shadow-md hover:shadow-lg transform hover:-translate-y-0.5",
    ghost: "text-gray-700 dark:text-gray-300 hover:bg-gray-100/80 dark:hover:bg-gray-700/80 hover:text-gray-900 dark:hover:text-gray-100 focus:ring-gray-500 backdrop-blur-sm transition-all duration-300",
  ...
  const glowStyles = glow ? "shadow-[0_0_20px_rgba(99,102,241,0.4)] hover:shadow-[0_0_30px_rgba(99,102,241,0.6)]" : "";
