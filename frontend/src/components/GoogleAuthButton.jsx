...
const GoogleAuthButton = ({ 
  ...
  const handleError = () => {
    console.error('Google OAuth error: User cancelled or authentication failed');
    setStatus('error');
    setTimeout(() => {
      setStatus(null);
  ...
  const getButtonStyle = () => {
    const baseStyle = "relative overflow-hidden transition-all duration-300 transform hover:scale-105 focus:scale-105 active:scale-95";
