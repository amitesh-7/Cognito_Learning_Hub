        ...
        >
          ...
          >
            ...
            <motion.div className="text-center" variants={staggerItem}>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Teachers create quizzes with AI, students browse and take them.
              </p>
            </motion.div>
          ...
          >
              ...
              <Card className="h-full">
                <CardContent className="p-8">
                  <p className="italic text-gray-600 dark:text-gray-300 mb-6">
                    "Cognito Learning Hub has completely transformed how I
                    create quizzes for my students. The AI generates
                    high-quality questions in seconds!"
                  </p>
            ...
            <motion.div variants={staggerItem}>
              <Card className="h-full">
                <CardContent className="p-8">
                  <p className="italic text-gray-600 dark:text-gray-300 mb-6">
                    "The AI Doubt Solver is amazing! I can get instant help with
                    complex topics anytime I'm studying."
                  </p>
                  <div className="flex items-center">
        ...
        >
          <motion.div className="space-y-6" variants={staggerItem}>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              ...
              Cognito Learning Hub to make learning more engaging and effective.
            </p>
            <motion.div
