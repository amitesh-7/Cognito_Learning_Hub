...
const DuelMatchSchema = new mongoose.Schema({
  ...
  quizId: { type: mongoose.Schema.Types.ObjectId, required: true, ref: 'Quiz', index: true },
...
DuelMatchSchema.index({ createdAt: 1 }, { expireAfterSeconds: 300, partialFilterExpression: { status: 'waiting' } });

// Auto-expire completed matches after 7 days
DuelMatchSchema.index({ completedAt: 1 }, { expireAfterSeconds: 604800, partialFilterExpression: { status: 'completed' } });
